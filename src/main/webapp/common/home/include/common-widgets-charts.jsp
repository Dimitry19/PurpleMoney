        ...
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <hr>
                    &lt;%&ndash;Styling for the area chart can be found in the <code>/js/demo/chart-area-demo.js</code> file.&ndash;%&gt;
                </div>
            </div>
            <!-- Bar Chart -->
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <hr>
                    &lt;%&ndash;Styling for the bar chart can be found in the <code>/js/demo/chart-bar-demo.js</code> file.&ndash;%&gt;
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <hr>
                    &lt;%&ndash;Styling for the donut chart can be found in the <code>/js/demo/chart-pie-demo.js</code> file.&ndash;%&gt;
                </div>
            </div>
        </div>
    </div>--%>
