...
<head>
	...
	<!--Bootstrap- select plugin-->
		...
		<link rel="stylesheet"  href="<s:url value="/common/jQuery-Ccpicker/css/jquerysctipttop.css"/>">
		<link rel="stylesheet"  href="<s:url value="/common/jQuery-Ccpicker/css/jquery.ccpicker.css"/>">

        <link rel="stylesheet" href="<s:url value="/common/pickadate.js/lib/themes/default.css" id="theme_base" />">
        <link rel="stylesheet"  href="<s:url value="/common/pickadate.js/lib/themes/default.date.css" id="theme_date" />">
        <link rel="stylesheet" href="<s:url value="/common/pickadate.js/lib/themes/default.time.css" id="theme_time" />">
		<link rel="stylesheet"  href="<s:url value="/common/pickadate.js-3.6.2/lib/themes/rtl.css"/>">
...
--%>
    ...
    <script src="<s:url value="/common/pickadate.js/lib/picker.js"/>"></script>
    <script src="<s:url value="/common/pickadate.js/lib/picker.date.js"/>"></script>
    <script src="<s:url value="/common/pickadate.js/lib/picker.time.js"/>"></script>
