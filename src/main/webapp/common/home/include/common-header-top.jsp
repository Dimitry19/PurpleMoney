...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#menuMembers" aria-expanded="true" aria-controls="collapsePages">
        ...
        <!-- Nav Item - Sessions Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#menuSessions" aria-expanded="true" aria-controls="collapsePages">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <!-- Topbar Search -->
                <s:form id="" action="searchAction" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                    <div class="input-group">
                        <s:textfield  placeholder="%{getText('common.menu.search')}" class="form-control bg-light border-0 small" aria-label="Search" aria-describedby="basic-addon2" />
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small"><s:property value="%{currentMember.getId().getName()}"/></span>   <%--<s:property value="%{user.username}" /></span>--%>
                            <img class="img-profile rounded-circle" src="<s:url value="/common/template/img/login-jo.jpeg"/>">

                        </a>
                        <!-- Dropdown - User Information -->
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                            <a class="dropdown-item" href="<s:url action="infoMemberAction"/>">
                                <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400" aria-hidden="true"></i>&nbsp;<s:text name="common.menu.about.user"/>
                            </a>
                            ...
                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400" aria-hidden="true"></i>&nbsp;<s:text name="common.menu.logout"/></a>
                        </div>
                    </li>
                </ul>
            </nav>
