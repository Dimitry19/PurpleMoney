...
<script src="<s:url value="/common/js/select2/dist-4.0.10/js/select2.full.js"/>"></script>
<script src="<s:url value="/common/js/select2/dist-4.0.10/js/i18n/en.js"/>"></script>
<script src="<s:url value="/common/js/select2/dist-4.0.10/js/i18n/fr.js"/>"></script>
<script src="<s:url value="/common/js/select2/dist-4.0.10/js/i18n/it.js"/>"></script>
<script src="<s:url value="/common/js/select2/select2.js"/>"></script>
