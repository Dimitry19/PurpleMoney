...
<div class="container text-center">
    ...
    <div class="card card-perso">
        ...
        <div class="card-body center-element">
                        ...
                        <div class="col-md-6">
                            <div class="input-group mb-3">
                                ...
                                <s:select
                                        ...
                                        label="EventType"
                                        id="eventType"
                                        list="eventTypes" listKey="eventCode"	listValue="%{description}"
                                        name="event.eventType.eventCode"
                                        emptyOption="false"
            ...
            <%--<s:form class="form-horizontal"  action="addEventType" id="formEventTypeRegister">
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="input-group">
